...
![alt text](https://img.shields.io/badge/Status-In--Development-yellow)

![alt text](https://img.shields.io/badge/Platform-WebGL-orange)

![alt text](https://img.shields.io/badge/Engine-Unity%206-blue)
...
🕹️ Cách chơi
Di chuyển: Phím W, A, S, D hoặc Mũi tên.
Tương tác (NPC/Cửa/Vật phẩm): Phím E.
Mở điện thoại: Phím Tab.
Mục tiêu: Thu thập đủ 16 huy chương ẩn giấu tại các khu vực:
Cổng A
Tòa B
Sân thư viện
Sân bóng đá
...
🛠️ Công nghệ sử dụng
Unity 6
C# Scripting: Kiến trúc Component-based & ScriptableObjects.
...
Clone repository:
git clone https://github.com/your-username/UIT-20-Years.git
